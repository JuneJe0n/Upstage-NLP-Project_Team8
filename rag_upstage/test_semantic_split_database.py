...
from test_utils import load_pdf, sem_split_documents


threshold = "standard_deviation"   ############# 설정 ("percentile", "standard_deviation", "interquartile", "gradient")
...
def main():
    ...
    chunks = sem_split_documents(documents,threshold)
