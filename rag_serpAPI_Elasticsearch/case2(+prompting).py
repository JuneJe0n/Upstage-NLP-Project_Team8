...
#### 질문을 -> 유형:핵심질문 format으로 변환하여 query 사용
from langchain_core.prompts import PromptTemplate
from langchain_upstage import ChatUpstage
from langchain.vectorstores import ElasticsearchStore
from langchain_upstage import UpstageEmbeddings
from langchain.schema import Document
from utils import read_data, extract_question_queries, configure_elasticsearch, search_web, calculate_accuracy, search_elastic, create_context
...
prompt_template = PromptTemplate.from_template(
    """
    Please provide most correct answer from the following context and information.
    If the answer is not exist, please write "The answer is not present in the context."
    ---
    Question: {question}
    ---
...
for i in range(len(prompts)):
    ...
    relevant_documents = search_elastic(query, es_client, document_index)
    ...
    input_dict = {"question": prompt, "information": query, "context": context}
